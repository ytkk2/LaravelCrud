$(function () {
    ...
    // call tabulator function and create tables
    // add city, local and street_address fields to make address
    var customMutator1 = function(value, data, type, params, component){
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            {title: "ID", field: "id",width: 35, headerFilter: "input", sorter: "number", headerFilterPlaceholder: " "},
            {title: "Name", field: "name", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Email", field: "email", headerFilter: "input", headerFilterPlaceholder: " "},
			{title: "Postcode", field: "postcode", headerFilter:"input", headerFilterPlaceholder: " "},
            {title: "Prefecture", field: "prefecture.display_name", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Address", field: "address", mutator:customMutator1, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Updated At", field: "updated_at", headerFilter: "input", headerFilterPlaceholder: " "},
    ...
    $('#datalist').tabulator('setData', rootUrl + '/api/company/companies/getCompaniesTabular');
