...
Route::POST('/comptany/create', 'Backend\CompanyController@create')->name('company.create');
...
Route::POST('/postcode/{postcode}/address', 'AddressController@getAddressByPostcode'); 